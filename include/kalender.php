...
$nbc="F5F5F5"; // NORMAL BACKGROUND COLOR
$abc="D3E7F8"; // MARKED BACKGROUND COLOR
$tbc="#80C2EB"; // TODAY'S BACKGROUND COLOR
...
<style TYPE="text/css">
<!--
.monthyear {  font-family: Verdana, Arial, Helvetica, sans-serif; font-size: <?php echo $fsm;?>px; font-weight: <?php echo $fwm;?>; color: #000000}
.daynames {  font-family: Arial, Helvetica, sans-serif; font-size: <?php echo $fsd;?>px; font-weight: <?php echo $fwd;?>; color: #000000}
.dates {  font-family: Verdana, Arial, Helvetica, sans-serif; font-size: <?php echo $fsn;?>px; font-weight: <?php echo $fwn;?>; color: #000000}
-->
</style>
<?php
...
?>
<table WIDTH="<?php echo $tw;?>" BORDER="0" CELLSPACING="0" CELLPADDING="2">
  <tr> 
    <td CLASS="monthyear"> 
      <div ALIGN="center"> 
        <?php echo "$mn";?>
...
<table WIDTH="<?php echo $tw;?>" BORDER="0" CELLSPACING="2" CELLPADDING="1" CLASS="daynames">
  <tr ALIGN="center"> 
<?php
for ($I=0;$I<7;$I++) {
$dayprint=$daystart+$I;
